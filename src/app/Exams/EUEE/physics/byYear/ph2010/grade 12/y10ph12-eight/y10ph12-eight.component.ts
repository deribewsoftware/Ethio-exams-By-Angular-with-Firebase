...
@Component({
  selector: 'app-y10ph12-eight',
  templateUrl: './y10ph12-eight.component.html',
  styleUrls: ['./y10ph12-eight.component.css']
})
export class Y10ph12EightComponent {
  ...
  subTitle="Chapter Eight"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Eight").subscribe((data:any) =>{

...
@Component({
  selector: 'app-y10ph12-three',
  templateUrl: './y10ph12-three.component.html',
  styleUrls: ['./y10ph12-three.component.css']
})
export class Y10ph12ThreeComponent {
  ...
  subTitle="Chapter Three"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Three").subscribe((data:any) =>{

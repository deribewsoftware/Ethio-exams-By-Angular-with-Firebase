...
@Component({
  selector: 'app-y10ph12-one',
  templateUrl: './y10ph12-one.component.html',
  styleUrls: ['./y10ph12-one.component.css']
})
export class Y10ph12OneComponent {
  ...
  subTitle="Chapter One"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","One").subscribe((data:any) =>{

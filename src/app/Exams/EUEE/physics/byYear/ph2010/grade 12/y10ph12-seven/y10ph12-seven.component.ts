...
@Component({
  selector: 'app-y10ph12-seven',
  templateUrl: './y10ph12-seven.component.html',
  styleUrls: ['./y10ph12-seven.component.css']
})
export class Y10ph12SevenComponent {
  ...
  subTitle="Chapter Seven"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Seven").subscribe((data:any) =>{

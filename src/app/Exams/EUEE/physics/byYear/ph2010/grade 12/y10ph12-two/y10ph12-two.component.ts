...
@Component({
  selector: 'app-y10ph12-two',
  templateUrl: './y10ph12-two.component.html',
  styleUrls: ['./y10ph12-two.component.css']
})
export class Y10ph12TwoComponent {
  ...
  subTitle="Chapter Two"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Two").subscribe((data:any) =>{

...
@Component({
  selector: 'app-y10ph12-six',
  templateUrl: './y10ph12-six.component.html',
  styleUrls: ['./y10ph12-six.component.css']
})
export class Y10ph12SixComponent {
  ...
  subTitle="Chapter Six"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Six").subscribe((data:any) =>{

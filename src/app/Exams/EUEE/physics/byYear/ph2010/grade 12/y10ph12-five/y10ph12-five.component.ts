...
@Component({
  selector: 'app-y10ph12-five',
  templateUrl: './y10ph12-five.component.html',
  styleUrls: ['./y10ph12-five.component.css']
})
export class Y10ph12FiveComponent {
  ...
  subTitle="Chapter Five"
    ...
    ngOnInit():void {
       this.examsService.getExamsByByChapter("Subject","Physics","Year","2010","Grade","12","Chapter","Five").subscribe((data:any) =>{
